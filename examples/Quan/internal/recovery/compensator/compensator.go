...
type compensationRepository interface {
	ListDueFailedForCompensation(ctx context.Context, limit int) ([]taskmodel.RecoveryCandidate, error)
	ListSuspendedForCompensation(ctx context.Context, staleBefore time.Time, limit int) ([]taskmodel.RecoveryCandidate, error)
	ListStaleRunningForCompensation(ctx context.Context, staleBefore time.Time, limit int) ([]taskmodel.RecoveryCandidate, error)
...
func New(repo compensationRepository, queue compensationQueue, cfg Config) (*Compensator, error) {
